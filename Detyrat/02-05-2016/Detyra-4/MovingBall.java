...
{ private int x_pos;  // ball's center x-position
  ...
  { x_pos = x_pos + (x_velocity * time_units);
    ...
    if ( container.inVerticalContact(y_pos) )
     ...
     if ( ( (x_pos == (container.sizeOf()/2)-10) ||
           (x_pos == (container.sizeOf()/2)-9) ||
           (x_pos == (container.sizeOf()/2)-8) ||
           (x_pos == (container.sizeOf()/2)-7) ||
           (x_pos == (container.sizeOf()/2)-6) ||
           (x_pos == (container.sizeOf()/2)-5) ||
           (x_pos == (container.sizeOf()/2)-4) ||
           (x_pos == (container.sizeOf()/2)-3) ||
           (x_pos == (container.sizeOf()/2)-2) ||
           (x_pos == (container.sizeOf()/2)-1)) && ((y_pos == (container.sizeOf()/2)-10) ||
           (y_pos == (container.sizeOf()/2)-9) ||
           (y_pos == (container.sizeOf()/2)-8) ||
           (y_pos == (container.sizeOf()/2)-7) ||
           (y_pos == (container.sizeOf()/2)-6) ||
           (y_pos == (container.sizeOf()/2)-5) ||
           (y_pos == (container.sizeOf()/2)-4) ||
           (y_pos == (container.sizeOf()/2)-3) ||
           (y_pos == (container.sizeOf()/2)-2) ||
           (y_pos == (container.sizeOf()/2)-1) ) )
